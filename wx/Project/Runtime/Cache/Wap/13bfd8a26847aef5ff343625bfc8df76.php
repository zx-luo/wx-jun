...
<link href="/Public/css/base.css?v=<?php echo rand(0,100);?>" rel="stylesheet" type="text/css">
<link href="/Public/Weixin/css/index.css?v=<?php echo rand(0,100);?>" rel="stylesheet" type="text/css">
...
function jsApiCall()	{
		WeixinJSBridge.invoke(
			...
			function(res){
				$("input[name='msgbox']").val(4);
				if(res.err_msg == "get_brand_wcpay_request:ok"){
			        $('.msgbox').show();
			        $('.msgbox .txt').text('充值成功');
				} else {
			        $('.msgbox').show();
			        $('.msgbox .txt').text('取消充值');
				}
			}
		);
}
...
<body>
<div style="line-height:60px; text-align:center;">请等待支付......</div>
<script>
$(document).ready(function () { 
