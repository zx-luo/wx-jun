...
if($post['isWriteNote'] == '1'){
   echo '<img id="qrimage" src="'.SKL_WEBROOT_PATH.'images/wxqrcode.png?cacheTime='.$cacheTime.'" width="230" />
   ';	
}else{   
 	      
   echo '<img id="qrimage" src="'.SKL_WEBROOT_PATH.'images/wxqrcode/'.$post['money'].'/'.$post['fileName'].'?cacheTime='.$cacheTime.'" width="230" />
   ';	
}
?>           
