...
$(document).ready(function () { 
	$(function(){
		  $.get("<?php echo U('ajaxyongjin');?>",{},function(res){
			 $(".yongjin2").append(res.html);
		  },'json');
	});
	...
	$(window).scroll(function(){
	   ...
	   if(scrollTop + windowHeight >= scrollHeight){
		  ...
		  $.get("<?php echo U('ajaxyongjin');?>",{page:page},function(res){
			 $(".yongjin2").append(res.html);
   ...
   $(".yongjin2").delegate(".xiang", "click", function(){
...
<div class="yongjin3">今日剩余结算次数（含拆红包和佣金结算）：<?php echo ($cishu); ?>次</div>
<div class="yongjin2"></div>
