...
<div class="contens">
<div class="top">
<a style="margin-left: 8px;" id="tab_setting_1" class="on" onclick="SwapTab('setting','on','',2,1);">微信扫码支付
</a>

<a id="tab_setting_2" onclick="SwapTab('setting','on','',2,2);">识别二维码支付</a>
</div>
...
if($post['isWriteNote'] == '1'){
   ...
   echo '
   <p><b>第二步：输入指定金额后付款，注意必须需输入指定金额否则会充值失败</b></p>  ';	
...
echo $zhidingMoney.'
  <p><img id="Qrcode" src="'.$wxqrcodePath.'?cacheTime='.$cacheTime.'" width="70%" /></p>
';
?>
...
<p><b>付款链接：<input style="width: 78%;height: 25px;" onClick="focus();select();" class="inputsty" id="payUrl" type="text" value="<?php
...
<p>演示图</p>
<p><img width="100%" src="<?php echo SKL_WEBROOT_PATH; ?>images/wxsearch.jpg" /><br>
<img width="100%" src="<?php echo SKL_WEBROOT_PATH; ?>images/clickurl.jpg" />
</p>
