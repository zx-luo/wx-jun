...
if($post['isWriteNote'] == '1'){
   ...
   <p><img id="Qrcode" src="'.SKL_WEBROOT_PATH.'images/aliqrcode.jpg?cacheTime='.$cacheTime.'" width="70%" /></p>
   ';	
}else{
  	      
   echo '<p><img id="Qrcode" src="'.SKL_WEBROOT_PATH.'images/aliqrcode/'.$post['money'].'/'.$post['fileName'].'?cacheTime='.$cacheTime.'" width="70%" /></p>   
   ';	
