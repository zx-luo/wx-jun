...
<div class="index-daili publickuang">
<!--    <?php if(!empty($news[ncontent])): ?><div class="yongjin"><?php echo (htmlspecialchars_decode($news[ncontent])); ?></div><?php endif; ?> -->
   <div class="headtitle">长按保存下面的代理图片</div>
   <div class="dailiimg">
    <img src="./Uploads/daili/tma<?php echo (session('userid')); ?>.png">
   </div>
   <div style="color:#F00; text-align:center;"><a href="<?php echo U('Index/dailixq');?>" style="color:#F00; text-decoration:underline;">>>>>>佣金详细介绍<<<<<</a></div>
</div>
<script>
$(document).ready(function () { 
