...
.skl_contens{
	...
	width: 86%;
	min-height:<?php
	$dirNameCount=count($dirName);
	if($dirNameCount <= 9){ echo 480; }else{ echo ($dirNameCount/3)*150; } 
	?>px;
...
<div class="payBox">
<input type="text" value="<?php echo $post['username']; ?>" name="username" style="width:100%;height:30px;" />
</div>
-->
...
if($payV == $this->aliAlias){
	echo '<li data-EmailKey="'.$this->aliEmailKey.'" data-TitleKey="'.$this->aliTitleKey.'" data-MoneyKey="'.$this->aliMoneyKey.'" data-payAlias="'.$this->aliAlias.'"><img src="'.SKL_WEBROOT_PATH.'images/'.$payV.'.png" height="20px" /></li>';

}elseif($payV == $this->wxAlias){

  echo '<li data-EmailKey="'.$this->wxEmailKey.'" data-TitleKey="'.$this->wxTitleKey.'" data-MoneyKey="'.$this->wxMoneyKey.'" data-payAlias="'.$this->wxAlias.'"><img src="'.SKL_WEBROOT_PATH.'images/'.$payV.'.png" height="20px" /></li>';
 
}elseif($payV == $this->tenAlias){

  echo '<li data-EmailKey="'.$this->tenEmailKey.'" data-TitleKey="'.$this->tenTitleKey.'" data-MoneyKey="'.$this->tenMoneyKey.'" data-payAlias="'.$this->tenAlias.'"><img src="'.SKL_WEBROOT_PATH.'images/'.$payV.'.png" height="20px" /></li>';
}
